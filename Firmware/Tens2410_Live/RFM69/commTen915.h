...
#ifndef _COMMTEN915_H_
#define _COMMTEN915_H_
...
Byte[0]=  Message type
	...
	@ = Data update broadcast and/or response to data request.
...
//Categories:
typedef enum {
	category_Information		= '0',
	category_CannedMessage		= '1',
	category_Operation			= '2',
	category_ParamArrayMsg		= '3',
	category_Inputs				= '4',
	category_Outputs			= '5',
	category_PowerSettings		= '6',
	category_Communications		= '8',
	category_CalibrationData	= 'A'
} enumCategory;
/*
...
typedef enum {
	devInfo_Summary				= '0',			//A packet of identification info about the device: DeviceId, NetworkId, DeviceName, SleepMode, AutosendInterval, SerialNumber
	devInfo_DeviceId			= '1',			//BoardId or ProductId
	devInfo_FWRev				= '2',			//Firmware Rev
	devInfo_ProductName			= '3',			//e.g. "Temp915H"
	devInfo_SerialNumber		= '4',			//This is used to provide the serial number and also used to broadcast a device's id with serial number attached for identification and verification purposes.
	...
	devInfo_CustomName			= '5',			//e.g. "Fam Room Temp"
	devInfo_Location			= '6'			//e.g. "Zone 3" or "Garage"
} enumDevInfo;


typedef enum {
	devOp_Status				= '0',			//Current status: Idle, Running, Alarm, etc.
	devOp_AlarmCount			= '5',			//Total count of active alarms
	devOp_AlarmNumber			= '6',			//Next field must include the index #
	devOp_AlarmText				= '7',			//Next field must include the index #
	devOp_ClearAlarm			= '8'			//Next field must include the index #, -1 for all alarms
} enumDevop;
