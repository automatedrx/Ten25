...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN16
    */
    GPIO_InitStruct.Pin = TENV_OUT_SENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(TENV_OUT_SENSE_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = BAT_V_SENSE_Pin|TENV_IN_SENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN16
    */
    HAL_GPIO_DeInit(TENV_OUT_SENSE_GPIO_Port, TENV_OUT_SENSE_Pin);

    HAL_GPIO_DeInit(GPIOB, BAT_V_SENSE_Pin|TENV_IN_SENSE_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PE15     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, IMU_CLK_Pin|IMU_MISO_Pin|IMU_MOSI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = PULSE_CH2_Pin|PULSE_CH3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM17_MspPostInit 0 */
    ...
    PE1     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = PULSE_CH1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_TIM17;
    HAL_GPIO_Init(PULSE_CH1_GPIO_Port, &GPIO_InitStruct);
